      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="flex flex-col md:flex-row justify-between items-center mb-12">
          ...
          <div className="mb-6 md:mb-0 text-center md:text-left">
            ...
            <p className="text-soft/60 text-sm max-w-xs">
              Crafting smart, reliable, and scalable digital products.
            </p>
          </div>
          ...
          <div className="flex space-x-6">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="w-10 h-10 rounded-full bg-secondary/50 flex items-center justify-center text-soft hover:bg-accent hover:text-primary transition-all duration-300 shadow-[0_0_10px_rgba(0,0,0,0.5)] hover:shadow-[0_0_15px_rgba(252,163,17,0.5)] hover:scale-110"
              aria-label="GitHub"
            >
              <FaGithub size={20} />
            </a>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center text-soft/50 text-xs">
          ...
          <p className="mt-2 md:mt-0">
            Designed & Built with{" "}
            <span className="text-accent hover:animate-pulse">
              Next.js & Tailwind
            </span>
          </p>
        </div>
